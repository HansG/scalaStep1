...
If you are planning to use hello-scala as scaffolding for your own project, consider cloning the repo with `git clone
...
* `renameProject` - replace hello-scala with your custom name and adjust scala package names
...
This will bring into scope Tapir builder methods and schemas for documentation, along with hello-scala-specific
customizations.
