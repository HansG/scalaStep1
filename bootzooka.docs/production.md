...
Use [Helm](https://helm.sh/) to easily deploy hello-scala into [Kubernetes](https://kubernetes.io/) cluster.
...
### Fetch and Customize hello-scala chart

```
helm fetch softwaremill/bootzooka --untar
```

### Install hello-scala chart

```
helm install --generate-name bootzooka
```

Please see [hello-scala Helm Chart
