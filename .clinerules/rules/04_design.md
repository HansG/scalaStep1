...
This file provides guidance to Cline when working with User Interfaces

## Overview
Prefer focused, minimal dark interfaces in particular for developer productivity tools.
